...
class PPTGeneratorService:
    ...
    def add_scene_slide(
        self, prs: Presentation, scene_data: Dict[str, Any], scene_index: int
    ) -> None:
        """
        ...
        # Dialogue - handle both string and list formats
        dialogue = scene_data.get("dialogue", "")
        if dialogue:
            if isinstance(dialogue, str):
                # Dialogue is a string, use as-is
                dialogue_texts = [dialogue]
            elif isinstance(dialogue, list):
                # Dialogue is a list of dicts
                dialogue_texts = []
                for d in dialogue:
    ...
    def generate_ppt(
        ...
        for ls_index, learning_step in enumerate(learning_steps):
            ...
            for scene_index, scene in enumerate(scenes):
                self.add_scene_slide(prs=prs, scene_data=scene, scene_index=scene_index)
